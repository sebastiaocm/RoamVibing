...
final class PackagingSecurityTests: XCTestCase {
    ...
    func testDocsExplainPrivilegedHelperSecurityAndRollback() throws {
        ...
        XCTAssertTrue(readme.contains("Touch ID Helper"))
        XCTAssertTrue(readme.contains("one-time administrator approval"))
        XCTAssertTrue(readme.contains("administrator-password flow"))
